...
#include "netimmerse/NiProperties.h"
...
public:
	...
	DEFINE_MEMBER_FN_1(ctor, NiTriBasedGeom*, 0x00D5A840, NiTriShapeData* geometry);
};
...
public:
	...
	//
	DEFINE_MEMBER_FN_0(ctor, BSDynamicTriShape*, 0x00D38BA0);
};
...
enum VertexMasks : UInt64 {
	DESC_MASK_VERT	 = 0xFFFFFFFFFFFFFFF0ULL,
	DESC_MASK_UVS	 = 0xFFFFFFFFFFFFFF0FULL,
	DESC_MASK_NBT	 = 0xFFFFFFFFFFFFF0FFULL,
	DESC_MASK_SKCOL	 = 0xFFFFFFFFFFFF0FFFULL,
	DESC_MASK_DATA	 = 0xFFFFFFFFFFF0FFFFULL,
	DESC_MASK_OFFSET = 0xFFFFFF0000000000ULL,
...
public:
	...
	DEFINE_MEMBER_FN(Copy, NiSkinInstance*, 0x00D17E90);
	DEFINE_MEMBER_FN(ctor, NiSkinInstance*, 0x00D45BD0);
};

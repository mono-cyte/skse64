...
#include "netimmerse/NiObjects.h"
#include "netimmerse/NiMaterial.h"
...
public:
	...
	DEFINE_MEMBER_FN(InitializeShader, UInt32, 0x014AD420, BSGeometry* geometry);
	DEFINE_MEMBER_FN(SetMaterial, UInt32, 0x0147BFF0, BSLightingShaderMaterial* material, bool unk1); // unk1 usually 1
	DEFINE_MEMBER_FN(SetFlags, UInt64, 0x0147BEE0, UInt8 unk1, UInt8 unk2);
	// InvalidateMaterial was inlined away

	DEFINE_MEMBER_FN(InvalidateTextures, void, 0x014AD7D0, UInt32 unk1); // unk1 usually 0, called after material Releases textures
};

...
public:
	...
	DEFINE_MEMBER_FN(SetExpression, void, 0x0041D540, UInt32 type, float value);
	DEFINE_MEMBER_FN(Reset, void, 0x0041CE40, float value, UInt8 unk1, UInt8 unk2, UInt8 unk3, UInt8 unk4);

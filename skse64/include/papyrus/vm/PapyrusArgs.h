...
template <>
UInt64 GetTypeID<void>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<UInt32>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<SInt32>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<int>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<float>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<bool>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<BSFixedString>(VMClassRegistry* registry);

template <>
UInt64 GetTypeID<VMArray<UInt32>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMArray<SInt32>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMArray<int>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMArray<float>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMArray<bool>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMArray<BSFixedString>>(VMClassRegistry* registry);

template <>
UInt64 GetTypeID<VMResultArray<UInt32>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMResultArray<SInt32>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMResultArray<int>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMResultArray<float>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMResultArray<bool>>(VMClassRegistry* registry);
template <>
UInt64 GetTypeID<VMResultArray<BSFixedString>>(VMClassRegistry* registry);

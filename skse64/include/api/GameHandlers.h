...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B79A0, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7A30, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7BF0, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7BA0, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7DB0, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7D60, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7E00, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7C40, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B9060, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B9080, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B7FB0, Actor* form, UInt32 unk04);
};
...
public:
	...
	DEFINE_MEMBER_FN(Process_Origin, UInt8, 0x007B8110, Actor* form, UInt32 unk04);
};

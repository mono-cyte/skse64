...
public:
	BSReadLocker(BSReadWriteLock* lock) {
		m_lock = lock;
		CALL_MEMBER_FN(m_lock, LockForRead)();
	}
...
public:
	BSWriteLocker(BSReadWriteLock* lock) {
		m_lock = lock;
		CALL_MEMBER_FN(m_lock, LockForWrite)();
	}
...
public:
	BSReadAndWriteLocker(BSReadWriteLock* lock) {
		m_lock = lock;
		CALL_MEMBER_FN(m_lock, LockForReadAndWrite)();
	}

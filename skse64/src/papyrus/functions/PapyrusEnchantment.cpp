...
namespace papyrusEnchantment {
	...
	UInt32 GetNumEffects(EnchantmentItem* thisMagic) { return magicItemUtils::GetNumEffects(thisMagic); }

	float GetNthEffectMagnitude(EnchantmentItem* thisMagic, UInt32 index) { return magicItemUtils::GetNthEffectMagnitude(thisMagic, index); }

	UInt32 GetNthEffectArea(EnchantmentItem* thisMagic, UInt32 index) { return magicItemUtils::GetNthEffectArea(thisMagic, index); }

	UInt32 GetNthEffectDuration(EnchantmentItem* thisMagic, UInt32 index) { return magicItemUtils::GetNthEffectDuration(thisMagic, index); }

	EffectSetting* GetNthEffectMagicEffect(EnchantmentItem* thisMagic, UInt32 index) { return magicItemUtils::GetNthEffectMagicEffect(thisMagic, index); }

	UInt32 GetCostliestEffectIndex(EnchantmentItem* thisMagic) { return magicItemUtils::GetCostliestEffectIndex(thisMagic); }

	void SetNthEffectMagnitude(EnchantmentItem* thisMagic, UInt32 index, float value) { magicItemUtils::SetNthEffectMagnitude(thisMagic, index, value); }

	void SetNthEffectArea(EnchantmentItem* thisMagic, UInt32 index, UInt32 value) { magicItemUtils::SetNthEffectArea(thisMagic, index, value); }

	void SetNthEffectDuration(EnchantmentItem* thisMagic, UInt32 index, UInt32 value) { magicItemUtils::SetNthEffectDuration(thisMagic, index, value); }

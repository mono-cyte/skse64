...
public:
	MatchSkillPerks(Actor* actor, bool unowned, bool allRanks) :
		m_actor(actor), m_unowned(unowned), m_allRanks(allRanks) {}
...
public:
	PerkFormListVisitor::PerkFormListVisitor(BGSListForm* list, Actor* actor, bool unowned, bool allRanks) :
		MatchSkillPerks(actor, unowned, allRanks) {
		m_formList = list;
	}
...
public:
	PerkArrayVisitor::PerkArrayVisitor(VMResultArray<BGSPerk*>* perkArray, Actor* actor, bool unowned, bool allRanks) :
		MatchSkillPerks(actor, unowned, allRanks) {
		m_perks = perkArray;
	}
	virtual void AddPerk(BGSPerk* perk) {

...
Options::Options() :
	m_launchCS(false), m_setPriority(false), m_priority(0), m_crcOnly(false), m_optionsOnly(false), m_waitForClose(false), m_verbose(false), m_skipLauncher(true), m_launchSteam(false), m_noTimeout(false), m_affinity(0) {
	//
}
